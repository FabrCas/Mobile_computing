...
levelSound= audio.loadSound("sounds/space2.mp3")
...
function scene:show( event )
	...
	myLevel:loadLevel("Level22") -- set your scene/level name here
...
elseif angolo <-45 and angolo >-135 then --u
  obj[i].view.scritta.rotation = obj[i].view.rotation +90
	...
	sfondo= myLevel:getLayerObject("Layer 1","525c5fa9a8ee7ebd149cf88e17887342_0").view
