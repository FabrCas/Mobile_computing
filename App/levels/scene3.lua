...
function scene:show( event )
	...
	myLevel:loadLevel("Level03") -- set your scene/level name here
	...
	for i=7,48 do
	obj[i] = {}
	obj[i] = myLevel:getLayerObject("Layer 1","B10_"..string.format(i))
	print(i) print("\n numero ")
...
elseif angolo <-45 and angolo >-135 then --u
  obj[i].view.scritta.rotation = obj[i].view.rotation +90
	...
	sfondo= myLevel:getLayerObject("Layer 1","natura3_0").view
