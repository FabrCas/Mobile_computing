-- Generated by Level Director X v1.1.0 on mer dic 4 18:31:23 2019 --
...
-----------------------------------
	...
	assets['ball_0']={file ='default ball.png',name='ball_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=0,spriteSheetName='ball',frameCount=1,
		physics={isEnabled=true,source='Asset',bodyType='static',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=1,isBullet=false,shapes={{bodyShape='Round',shape={},bounce=0.2,friction=0.3,density=1,radius=100,categoryBits=0,maskBits=0,groupIndex=0},}	}  }
