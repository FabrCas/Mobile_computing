...
levelSound= audio.loadSound("sounds/dino.mp3")
...
function scene:show( event )
	...
	myLevel:loadLevel("Level20") -- set your scene/level name here
	...
	for i=1,48 do 
		print("fdshgj"..i)
	obj[i] = {}
	obj[i] = myLevel:getLayerObject("Layer 1","B08_"..string.format(i))
	...
	obj[i].view.life = 1
	else if (obj[i].view.vita=='6') then 
	obj[i].view.life = 6
	else 
    obj[i].view.life = 3 end
...
elseif angolo <-45 and angolo >-135 then --u
  obj[i].view.scritta.rotation = obj[i].view.rotation +90
	...
	sfondo= myLevel:getLayerObject("Layer 1","roma20_2").view
