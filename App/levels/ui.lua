-- Generated by Level Director X v1.1.0 on mer dic 11 15:59:58 2019 --
...
-----------------------------------
	...
	assets['static part ui_0']={file ='static part ui.png',name='static part ui_0',class='',aX=0.5,aY=0.5,width=640,height=960,frame=0,spriteSheetName='static part ui',frameCount=1,
		physics={isEnabled=true,source='Asset',bodyType='static',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=1,isBullet=false,shapes={{bodyShape='Polygon',shape={-317,352,-259,355,-157,414},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={-173,406,-42,441,-40,449},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={-68,436,76,438,76,447},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={56,440,179,403,185,419},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={162,409,254,359,318,349},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={247,363,263,349,317,347},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={-213,-390,-155,-387,-53,-328},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={-230,-477,-172,-474,-70,-415},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={38,-389,96,-386,198,-327},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},{bodyShape='Polygon',shape={152,-391,210,-388,312,-329},bounce=0.2,friction=0.3,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=0},}	}  }
