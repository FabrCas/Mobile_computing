-- Generated by Level Director X v1.1.0 on mer dic 18 20:26:29 2019 --
...
-----------------------------------
	...
	assets['1Sheet_0']={file ='1Sheet.png',name='1Sheet_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=1,spriteSheetName='1Sheet',frameCount=3,
		sequenceData={{name='1+',frames={ 1,3 },time =500,loopCount=1,loopDirection='forward' },{name='1-',frames={ 1,2 },time =500,loopCount=0,loopDirection='forward' },},
	...
	assets['2Sheet_0']={file ='2Sheet.png',name='2Sheet_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=1,spriteSheetName='2Sheet',frameCount=3,
		sequenceData={{name='2+',frames={ 1,3 },time =500,loopCount=1,loopDirection='forward' },{name='2-',frames={ 1,2 },time =500,loopCount=0,loopDirection='forward' },},
		sequenceInfo={default='',play=false },
		 }
	assets['3Sheet_0']={file ='3Sheet.png',name='3Sheet_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=1,spriteSheetName='3Sheet',frameCount=3,
		sequenceData={{name='3+',frames={ 1,3 },time =500,loopCount=1,loopDirection='forward' },{name='3-',frames={ 1,2 },time =500,loopCount=0,loopDirection='forward' },},
		sequenceInfo={default='',play=false },
		 }
	assets['4Sheet_0']={file ='4Sheet.png',name='4Sheet_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=1,spriteSheetName='4Sheet',frameCount=3,
		sequenceData={{name='4+',frames={ 1,3 },time =500,loopCount=1,loopDirection='forward' },{name='4-',frames={ 1,2 },time =500,loopCount=0,loopDirection='forward' },},
		sequenceInfo={default='',play=false },
		 }
	assets['5Sheet_0']={file ='5Sheet.png',name='5Sheet_0',class='',aX=0.5,aY=0.5,width=200,height=200,frame=1,spriteSheetName='5Sheet',frameCount=3,
		sequenceData={{name='5+',frames={ 1,3 },time =500,loopCount=1,loopDirection='forward' },{name='5-',frames={ 1,2 },time =500,loopCount=0,loopDirection='forward' },},
		sequenceInfo={default='',play=false },
		 }
