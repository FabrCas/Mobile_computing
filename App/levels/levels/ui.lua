-- Generated by Level Director X v1.1.0 on ven nov 29 19:29:42 2019 --
...
-----------------------------------
	...
	assets['static part ui_0']={file ='static part ui.png',name='static part ui_0',class='',aX=0.5,aY=0.5,width=640,height=960,frame=0,spriteSheetName='static part ui',frameCount=1,
		physics={isEnabled=true,source='Asset',bodyType='static',isFixedRotation=false,isSleepingAllowed=false,isSensor=false,linearDamping=0,angularDamping=0,gravityScale=0,isBullet=false,shapes={{bodyShape='Polygon',shape={-318,347,-264,348,-228,471,-317,468},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={-264,347,-193,392,-265,430},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={-207,384,-139,412,-199,444},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={-139,411,-69,429,-84,448},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={-70,428,-20,435,-20,446},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={-36,436,71,432,71,438},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={47,433,123,417,123,425},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={119,419,195,391,195,409},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={173,399,239,365,241,376},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={233,368,262,347,266,357},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},{bodyShape='Polygon',shape={263,348,319,348,319,357},bounce=0,friction=1,density=1,radius=0,categoryBits=0,maskBits=0,groupIndex=1},}	}  }
...
------------------------------------------
	...
	objects = {
	{name='buttonStats',objType='LDEllipse',class='',width=43.1667,height=42.3333,x=24,y=446,xScale=1*1,yScale=1*1,assetName='',
	...
	{name='buttonPausa',objType='LDEllipse',class='',width=43.1667,height=42.3333,x=294,y=447,xScale=1*1,yScale=1*1,assetName='',
		styleProps={radius=21.5833,cornerRadius=0,strokeWidth=1,strokeColorR=255/255,strokeColorG=255/255,strokeColorB=255/255,strokeColorA=1/255,fillColorR=255/255,fillColorG=255/255,fillColorB=255/255,fillColorA=1/255},
		fillProps ={fillType=0,fillAssetName='',fillFrame=0},
		gradientProps={direction=0,fillColorR=255/255,fillColorG=255/255,fillColorB=255/255,fillColorA=1/255},
		userProps = {},
