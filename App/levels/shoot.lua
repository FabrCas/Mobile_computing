-- Generated by Level Director X v1.1.0 on sab ott 5 18:03:13 2019 --
...
------------------------------------------
	...
	objects = {
	{name='cannon_fire_0',objType='LDImage',class='',width=92,height=136,x=158,y=68,xScale=1*1,yScale=1*1,assetName='cannon_fire_0',
		userProps = {},
		},
	}
