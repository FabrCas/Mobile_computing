-- Generated by Level Director X v1.1.0 on mar dic 17 18:02:03 2019 --
...
-----------------------------------
	...
	assets['cannon_fire_0']={file ='cannon_firegf.png',name='cannon_fire_0',class='',aX=0.5,aY=0.5,width=320,height=480,frame=1,spriteSheetName='cannon_fire',frameCount=14,
