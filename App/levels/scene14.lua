...
local channel1= audio.findFreeChannel(1)
  ...
  audio.play(levelSound,{channel= channel1, loops = -1})
	...
	myLevel:loadLevel("Level14") -- set your scene/level name here
	...
	obj[i] = {}
	print(i)
	obj[i] = myLevel:getLayerObject("Layer 1","B06_"..string.format(i))
...
elseif angolo <-45 and angolo >-135 then --u
  obj[i].view.scritta.rotation = obj[i].view.rotation +90
	...
	sfondo= myLevel:getLayerObject("Layer 1","maya11_0").view
